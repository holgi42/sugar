...
*/
   ...
   * @return Der String-Wert, der dem Parameter entspricht. Wenn nicht gefunden wird null zurück gegeben.
   */
    ...
    * Liest den Parameter an der Position.
    * @param pos Die Position des Parameters; 0-basiert
    * @return Der String-Wert, der dem Parameter entspricht. Wenn nicht gefunden wird Leerstring zurück gegeben.
    */
    public String getSl(int pos) {
  	  String erg="";
  	  if ((pos>=0)&&(pos<cm.length)) erg=cm[pos];
  	  return erg;
    }
